...
class _LoginScreenState extends State<LoginScreen> {
  ...
  // kept for any widget that still references _green / _textMuted directly
  static const _green       = _kNeon;
  static const _textMuted   = _kMuted;
  static const _textPrimary = _kWhite;
...
class _GoogleIcon extends StatelessWidget {
  ...
  Widget build(BuildContext context) => SizedBox(
        ...
        height: 20,
        child: CustomPaint(
            painter: _GooglePainter(bgColor: const Color(0xFF1C1C1C))),
      );
}
...
class _GooglePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawRect(
      Rect.fromLTWH(
          cx, cy - size.height * 0.12, r * 0.85, size.height * 0.24),
      Paint()
